...
export default function AnimationAssistant({ isOpen, onClose, animationData }: AnimationAssistantProps) {
    ...
    const handleSendMessage = async (msg: string) => {
        ...
        try {
            const suggestions = await assistantQuery({ type: 'animation', data: animationData, prompt: msg });
    ...
    return (
        <AssistantPanel isOpen={isOpen} onClose={onClose} title="Animation Assistant">
